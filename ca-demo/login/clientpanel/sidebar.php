    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-files-o"></i> <span>Upload Bank Statements</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="uploadfile.php"><i class="fa fa-circle-o"></i> Upload Files</a></li>
            <li><a href="exportlist.php"><i class="fa fa-circle-o"></i> View Files </a></li>
          </ul>
        </li>
